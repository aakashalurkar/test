     ...
     <CardMedia
      ...
      <div className={classes.details}>
        <CardContent className={classes.content}>
          ...
          <h3>
          {this.props.props.unit} {this.props.props.streetaddress} {this.props.props.city} {this.props.props.state} 

          <br/><br/>{this.props.props.zipcode} 
          <br/>{this.props.props.country}
         <br/>
         </h3>
          </Typography>
          ...
          <Typography gutterBottom variant="h1" >
           <h4>  ${this.props.props.nightly_rate} per night<br/><br/></h4>
          </Typography>
          
          <Typography variant="h2">
        {this.props.props.opendate_from} - {this.props.props.opendate_to}
          </Typography>
          <CardActions >
